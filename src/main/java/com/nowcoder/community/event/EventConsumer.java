...
public class EventConsumer implements CommunityConstant {
    ...
    @Autowired
    private ThreadPoolTaskScheduler taskScheduler;/////////////处理定时任务的线程池，jdk
    ...
    // 消费发帖事件
    @KafkaListener(topics = {TOPIC_PUBLISH})/////////监听发帖的主题，如果发帖记录到ES中
    ...
    public void handleDeleteMessage(ConsumerRecord record) {
        ...
        elasticsearchService.deleteDiscussPost(event.getEntityId());//ES搜索中删除这个帖子
    }
    ...
    public void handleShareMessage(ConsumerRecord record) {
        ...
        task.setFuture(future);//线程停止
    }
    /////////////////////这里是重点，怎么实现部署的策略：次数，时间的过期设置
